...
<head>
    ...
    @if(config('l5-swagger.defaults.ui.display.dark_mode'))
        <style>
            ...
            #dark-mode .btn, #dark-mode .tab li, #dark-mode .parameter__name,
            #dark-mode .parameter__type, #dark-mode .prop-format,
...
<script>
    window.onload = function () {
        ...
        // Safe fix for array_column error if securitySchemes is null
        @php
            $schemes = config('l5-swagger.defaults.securityDefinitions.securitySchemes') ?? [];
        @endphp

        @if(in_array('oauth2', array_column($schemes, 'type')))
        ui.initOAuth({
